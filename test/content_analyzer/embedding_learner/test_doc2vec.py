    ...
    def test_start_learning(self):
        test_list = [[0.11635043, 0.28827286, 0.26367947, -0.0368935, -0.07216292, -0.12885164, -0.06062358, 0.290583,
                     ...
                     [0.08266724, 0.18558007, 0.17412613, -0.02734668, -0.05606755, -0.05064456, -0.04156437,
                      0.12810938,
                      0.4672991, 0.14360814, -0.44134668, 0.1255639, -0.06440181, -0.23697469, 0.3259466, -0.298236,
                      -0.6237428, -0.04468865, 0.1474588, 0.08139123],
                     ...
                     [0.05343575, 0.20417786, 0.19907168, -0.05516035, -0.03117811, -0.12420024, -0.01822128,
                      0.24684472,
                      0.552818, 0.10604687, -0.47952488, 0.18031257, -0.14340155, -0.370736, 0.3842013, -0.34952304,
                      -0.70719564, -0.00113534, 0.09173155, 0.05633677]]

        test_results = GensimDoc2Vec(source=JSONFile("d2v_test_data.json"),
                                     preprocessor=NLTK(),
